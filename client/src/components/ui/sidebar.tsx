        ...
        <div
          className={cn(
            ...
            variant === "floating" || variant === "inset"
              ...
              : "group-data-[collapsible=icon]:w-[--sidebar-width-icon] group-data-[side=right]:border-r-0 group-data-[side=right]:border-l group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)] group-data-[collapsible=offcanvas]:group-data-[side=right]:right-[calc(var(--sidebar-width)*-1)]"
          )}
        >
          <div
            data-sidebar="sidebar"
